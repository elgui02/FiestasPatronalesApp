...
public class MunicipioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent = new Intent(this, FiestaMunicipioActivity.class);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try {
                    ...
                    intent.putExtra("nombre",fclick.getString("_municipio"));
    ...
    private class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String str="http://www.fiestas.sourcetip.com/rest/departamentos/"+b.getString("id")+"/municipios";
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                for (int x = 0; x < obj.length(); x++) {
                    ...
                    itemname.add(fiesta.getString("_municipio"));
                    Log.d("My App", fiesta.getString("_municipio"));
                }
            ...
            list.setAdapter(new ArrayAdapter<String>(MunicipioActivity.this,
                    R.layout.data_list,
